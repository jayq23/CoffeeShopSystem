...
import { hashPassword, ensureHashedPassword, todayIsoDate, getAdminUsername, getAdminPassword } from '../utils/helpers.js';
...
router.post('/login', async (req, res) => {
  try {
    ...
    if (role === 'admin') {
      ...
      const isPasswordMatch = bcrypt.compareSync(password, ensureHashedPassword(getAdminPassword()));
      if (!isPasswordMatch) {
